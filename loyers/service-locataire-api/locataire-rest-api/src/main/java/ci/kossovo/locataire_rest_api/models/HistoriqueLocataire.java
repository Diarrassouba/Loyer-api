...
public class HistoriqueLocataire {
  ...
  public void decrementerContrats() {
    this.nombreContratsTotal--;
  }

  public void decrementerRetards() {
    this.nombreRetardsPaiement--;
    if (this.nombreRetardsPaiement <= 0) {
      this.nombreRetardsPaiement = 0;
      this.actuellementEnRetard = false;
    }
  }
