...
public class ContratController {
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = ContratResponseDTO.class))),
        @ApiResponse(
            responseCode = "400",
  ...
  @PostMapping
  public ResponseEntity<ContratResponseDTO> createContrat(
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Liste des maisons récupérée avec succès",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = MaisonDispoView.class))),
        @ApiResponse(
            responseCode = "500",
