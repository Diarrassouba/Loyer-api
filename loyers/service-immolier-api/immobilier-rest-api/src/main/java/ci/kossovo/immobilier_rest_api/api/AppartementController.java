...
@Tag(name = "Gestion des Appartements", description = "API pour le catalogue des appartements dans une maison")
public class AppartementController {
  ...
  public ResponseEntity<AppartementResponseDTO> createAppartement(@PathVariable String maisonId,
    ...
    AppartementResponseDTO createdAppartement = maisonService.addAppartementToMaison(maisonId, requestDTO);
  ...
  @ApiResponse(responseCode = "200", description = "Liste des appartements", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = List.class)))
  @GetMapping
  public ResponseEntity<List<AppartementResponseDTO>> getAllAppartements(@PathVariable String maisonId) {
  ...
  @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Appartement mis à jour avec succès"),
  ...
  @PutMapping("/{id}")
  public ResponseEntity<AppartementResponseDTO> updateAppartement(@PathVariable String maisonId,
      @PathVariable String id, @Valid @RequestBody AppartementRequestDTO requestDTO) {

    AppartementResponseDTO updatedAppartement = maisonService.updateAppartement(maisonId, id, requestDTO);
