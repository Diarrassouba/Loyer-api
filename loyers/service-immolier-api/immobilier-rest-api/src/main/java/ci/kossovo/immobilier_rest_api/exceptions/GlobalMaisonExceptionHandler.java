...
public class GlobalMaisonExceptionHandler {
  ...
  /**
   * Gère les exceptions lorsqu'une entité n'est pas trouvée (ex: findById
  ...
  /**
   * Gère les exceptions de validation des DTOs annotés avec @Valid. Renvoie un
  ...
  /**
   * Gère les arguments illégaux, typiquement pour les validations métier
  ...
  /**
   * Gère toutes les autres exceptions non capturées pour éviter de fuiter des
   * traces de pile. Renvoie un statut 500 Internal Server Error. En production,
