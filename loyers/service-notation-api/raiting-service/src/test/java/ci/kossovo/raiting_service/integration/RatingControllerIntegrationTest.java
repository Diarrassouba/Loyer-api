...
public class RatingControllerIntegrationTest {
  ...
  void createNotation_shouldSucceed_whenDataIsValid() throws Exception {
    ...
    String descriptionDegats = "Dégâts constatés : mur fissuré";
    CreerNotationRequest request =
        new CreerNotationRequest(
            "loc-1",
            "contrat-1",
            4,
            5,
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.locataireId", is("loc-1")))
  ...
  @Test
  @DisplayName(
      "POST /api/notations - Échec : Doit retourner 404 Not Found si le contrat n'existe pas")
  ...
  @Test
  @DisplayName(
      "POST /api/notations - Échec : Doit retourner 400 Bad Request si le contrat ne correspond pas"
          + " au locataire")
  void createNotation_shouldReturn400_whenContratDoesNotMatchLocataire() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                "$.message",
                is("Le contrat contrat-1 n'est pas associé au locataire loc-1-correct")));
  }

  @Test
  @DisplayName(
      "POST /api/notations - Échec : Doit retourner 400 Bad Request pour un score invalide")
  void createNotation_shouldReturn400_forInvalidScore() throws Exception {
    ...
    CreerNotationRequest request =
        new CreerNotationRequest(
            ...
            "mgr-1",
            montant,
            descriptionDegats); // scoreProprete
    // > 5
