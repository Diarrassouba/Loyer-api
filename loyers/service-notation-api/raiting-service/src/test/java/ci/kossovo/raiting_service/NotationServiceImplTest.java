...
public class NotationServiceImplTest {
  ...
  @Mock private RatingMapper mapper;
  @Mock private EventGateway eventGateway;
  @Mock private ContratValideRepository contratValideRepository;
  @Mock private LocataireValideRepository locataireValideRepository;

  @InjectMocks private NotationServiceImpl notationService;
  ...
  public void createNotation_shouldSucceed_whenIdsAreValid() {
    ...
    NotationResponseDTO responseDTO =
        new NotationResponseDTO(
            "notation-1",
            locataireId,
            contratId,
            LocalDate.now(),
  ...
  public void createNotation_shouldFail_whenLocataireNotFound() {
    ...
    // Act & Assert
    assertThatThrownBy(() -> notationService.createNotation(request))
