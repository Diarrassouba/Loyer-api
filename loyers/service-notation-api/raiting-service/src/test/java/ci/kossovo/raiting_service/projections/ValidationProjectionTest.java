...
public class ValidationProjectionTest {
    ...
    void onLocataireCreeEvenement_shouldCreateLocataireValideView() {
        ...
        LocataireCreatedEvent event = new LocataireCreatedEvent(locataireId, "Bamba", "Moussa", locataireId,
                locataireId);
    ...
    void onContratCreeEvenement_shouldCreateContratValideView() {
        ...
        ContratCreatedEvent event = new ContratCreatedEvent(contratId, locataireId, "apt-1", "APPARTEMENT",
                BigDecimal.valueOf(800), LocalDate.now());
    ...
    void shouldHandleSequenceOfEvents() {
        ...
        LocataireCreatedEvent locataire1Event = new LocataireCreatedEvent("loc-1", "Nom1", "Prenom1", "loc-1", "loc-1");
        ContratCreatedEvent contrat1Event = new ContratCreatedEvent("contrat-1", "loc-1", "apt-1", "APPARTEMENT",
                BigDecimal.TEN, LocalDate.now());

        // Événements pour le second locataire
        LocataireCreatedEvent locataire2Event = new LocataireCreatedEvent("loc-2", "Nom2", "Prenom2", "loc-2", "loc-2");
        ...
        assertThat(contratValideRepository.findById("contrat-1").get().getLocataireId()).isEqualTo("loc-1");
    }
